function SMARTb(responseIndex, numStartStations, stationInitScheme, randomSeeds, R, lambda, beta)
rng(randomSeeds);
addpath('../utils/');
...
save(['SMARTb-' num2str(responseIndex) '-' num2str(numStartStations) '-' num2str(stationInitScheme)  '-' num2str(R) '-' num2str(lambda) '-' num2str(beta) '-' num2str(randomSeeds) '.mat'], ...
