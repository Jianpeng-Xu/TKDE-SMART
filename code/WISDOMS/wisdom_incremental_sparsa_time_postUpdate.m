function [W, A, BT, C] = wisdom_incremental_sparsa_time_postUpdate(XT, Y, W_old, A_old, BT_old, C_old, lambda2, eta2, beta2, R)
...
if isnan(sum(vect_result))
    A = A_old; BT = BT_old; C = C_old; W = W_old;
else
