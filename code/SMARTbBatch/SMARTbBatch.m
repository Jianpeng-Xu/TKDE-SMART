function SMARTbBatch(responseIndex, numStartStations, stationInitScheme, randomSeeds, R, lambda, beta, initModel)
...
save(['SMARTbBatch-' num2str(responseIndex) '-' num2str(numStartStations) ...
