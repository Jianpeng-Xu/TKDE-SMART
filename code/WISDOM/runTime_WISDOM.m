function runTime_WISDOM(responseIndex, numStartStations, stationInitScheme, randomSeeds, R, lambda, eta, beta)
...
save(['WISDOM-withRunTime-' num2str(responseIndex) '-' num2str(numStartStations) '-' num2str(stationInitScheme) '-' num2str(R) '-' num2str(lambda) '-' num2str(eta) '-' num2str(beta) '-' num2str(randomSeeds) '.mat'], ...
    'MAE_valid', 'MAE_test', 'MAE_ALL', 'MAE_test_station', ...
    'MAE_test_mean', 'MAE_valid_mean', 'W', 'V', 'A','B','C', ...
    'Y_hat', 'deszYMonth', ...
    'lambda', 'eta', 'beta', 'R', 'runTime');
