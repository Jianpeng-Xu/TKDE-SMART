function LossOverTimeWISDOM(responseIndex, numStartStations, stationInitScheme, randomSeeds, R, lambda, eta, beta)
...
save(['LossOverTimeWISDOM-' num2str(responseIndex) '-' num2str(numStartStations) '-' num2str(stationInitScheme) '-' num2str(R) '-' num2str(lambda) '-' num2str(eta) '-' num2str(beta) '-' num2str(randomSeeds) '.mat'], ...
    'MAE_valid', 'MAE_test', 'MAE_ALL', 'MAE_ALL_time', 'MAE_100Station_time', ...
    'MAE_test_station', ...
